	...
	>
		...
		{#if isMenuOpen}
			<footer class="u_m-top__lg header__nav-footer header__nav-footer--mobile">
				...
				<div use:wipeDown class="header__nav-footer-content-container">
					<a class="header__nav-footer-email" href="mailto:info@1stgreenhome.com">
						info@1stgreenhome.com
					</a>
					<a class="header__nav-footer-phone" href="tel:+14432169169"> (443) 216-9169 </a>
					<p class="header__nav-footer-address">10630 Riggs Hill Rd. Unit A</p>
					<span class="header__nav-footer-address"> Jessup, MD 20794</span>
				</div>
			</footer>
		{/if}
	</nav>
